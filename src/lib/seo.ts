...
export const publicRoutes = [
  ...
  { path: "/practice/beginner", priority: 0.7, changeFrequency: "monthly" },
  { path: "/practice/mysore", priority: 0.7, changeFrequency: "monthly" },
  { path: "/practice/meditation", priority: 0.7, changeFrequency: "monthly" },
