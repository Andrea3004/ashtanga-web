...
export function Header() {
  return (
    <header className="sticky top-0 z-30 flex min-h-18 items-center justify-between border-b border-line bg-background/95 px-5 py-3 text-text backdrop-blur sm:px-8 lg:px-20">
      <Link
        href="/"
        className="inline-flex min-w-0 items-center gap-3 rounded-md focus-visible:outline focus-visible:outline-4 focus-visible:outline-gold/30"
        aria-label={`${siteInfo.name} 홈`}
      >
