...
const aboutCards = [
  ...
  {
    title: "Teacher",
    body: "각자의 몸과 호흡, 움직임을 깊이 관찰하고 신체의 반응을 읽어내며, 지속적인 피드백을 통해 현재 단계에 가장 적합한 수련 방향과 자세, 호흡, 휴식의 범위를 함께 찾아갑니다.",
    href: "/about/teachers"
  },
  {
    title: "Philosophy",
    body: "유연성, 근지구력, 심신밸런스, 신진대사, 집중력 다섯 개의 축으로 모든 연령의 결핍을 정교하게 보완하고, 삶의 에너지를 회복하게 해주는 전통적, 현대적'완성형 요가 수련법'입니다. ",
